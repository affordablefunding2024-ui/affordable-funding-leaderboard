...
        }
        
        /* Added to highlight the editable fields as in your screenshot */
        .revenue-cell input,
        .target-revenue-cell input {
...
        }
        
        /* Added to make the table cells look similar to the screenshot */
        .revenue-cell, .target-revenue-cell {
...
                    </td>
                    <td class="px-4 py-4 whitespace-nowrap revenue-cell">
                        <input type="number" class="revenue-input text-sm" value="${broker.revenue}">
                    </td>
                    <td class="px-4 py-4 whitespace-nowrap target-revenue-cell">
                        <input type="number" class="target-revenue-input text-sm" value="${broker.targetRevenue}">
                    </td>
                    <td class="px-4 py-4 whitespace-nowrap">
                        <div class="w-32">
                            <div class="text-xs font-medium text-gray-900 mb-1 progress-text">${loansProgress}% Complete</div>
